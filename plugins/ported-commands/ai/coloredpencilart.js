...
module.exports = {
  name: 'coloredpencilart',
  aliases: ['colored_pencil_art'],
  category: 'ai',
  description: 'Generate AI image in colored pencil art style',
  usage: '.coloredpencilart <prompt>',
  ...
  async execute(sock, msg, args, extra) {
    ...
    try {
      ...
      const style = 'colored_pencil_art';
