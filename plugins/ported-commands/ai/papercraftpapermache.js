...
module.exports = {
  name: 'papercraftpapermache',
  aliases: ['papercraft_paper_mache'],
  category: 'ai',
  description: 'Generate AI image in papercraft paper mache style',
  usage: '.papercraftpapermache <prompt>',
  ...
  async execute(sock, msg, args, extra) {
    ...
    try {
      ...
      const style = 'papercraft_paper_mache';
