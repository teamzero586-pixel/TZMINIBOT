...
module.exports = {
  name: 'surrealpainting',
  aliases: ['surreal_painting'],
  category: 'ai',
  description: 'Generate AI image in surreal painting style',
  usage: '.surrealpainting <prompt>',
