...
module.exports = {
  name: 'adorablekawaii',
  aliases: ['adorable_kawaii'],
  category: 'ai',
  description: 'Generate AI image in adorable kawaii style',
  usage: '.adorablekawaii <prompt>',
