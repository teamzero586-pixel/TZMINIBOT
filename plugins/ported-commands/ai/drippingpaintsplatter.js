...
module.exports = {
  name: 'drippingpaintsplatter',
  aliases: ['dripping_paint_splatter'],
  category: 'ai',
  description: 'Generate AI image in dripping paint splatter style',
  usage: '.drippingpaintsplatter <prompt>',
  ...
  async execute(sock, msg, args, extra) {
    ...
    try {
      ...
      const style = 'dripping_paint_splatter';
