...
module.exports = {
  name: 'crossstitching',
  aliases: ['cross_stitching'],
  category: 'ai',
  description: 'Generate AI image in cross stitching style',
  usage: '.crossstitching <prompt>',
