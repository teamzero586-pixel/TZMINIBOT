...
module.exports = {
  name: 'papercraftpaperquilling',
  aliases: ['papercraft_paper_quilling'],
  category: 'ai',
  description: 'Generate AI image in papercraft paper quilling style',
  usage: '.papercraftpaperquilling <prompt>',
  ...
  async execute(sock, msg, args, extra) {
    ...
    try {
      ...
      const style = 'papercraft_paper_quilling';
