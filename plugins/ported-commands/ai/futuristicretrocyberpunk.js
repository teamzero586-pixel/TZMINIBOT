...
module.exports = {
  name: 'futuristicretrocyberpunk',
  aliases: ['futuristic_retro_cyberpunk'],
  category: 'ai',
  description: 'Generate AI image in futuristic retro cyberpunk style',
  usage: '.futuristicretrocyberpunk <prompt>',
  ...
  async execute(sock, msg, args, extra) {
    ...
    try {
      ...
      const style = 'futuristic_retro_cyberpunk';
